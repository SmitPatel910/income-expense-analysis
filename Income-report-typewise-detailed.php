...
if (strlen($_SESSION['detsuid']==0)) {
  header('location:logout.php');
    ...
    <head>
        ...
        <title>Income Analysis || Typewise Income Report</title>
			...
			<div class="table-responsive">
                        <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                            <thead>
                                ...
                                $ret=mysqli_query($con,"SELECT IncomeDate,Remark,Type_Income,(IncomeAmount) as totaldaily FROM `tbleincome`  where ((IncomeDate BETWEEN '$fdate' and '$tdate') && (UserId='$userid') && (Type_Income = '$types'))");
                                $cnt=1;
                                while ($row=mysqli_fetch_array($ret)) {
                                    ...
                                    <td style="color:red"><?php  echo $row['Type_Income'];?></td>
