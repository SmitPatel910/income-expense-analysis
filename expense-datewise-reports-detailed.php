...
$ret=mysqli_query($con,"SELECT ExpenseDate,ExpenseItem,Type,Expense,ExpenseCost as totaldaily FROM `tblexpense`  where (ExpenseDate BETWEEN '$fdate' and '$tdate') && (UserId='$userid') group by ExpenseDate");
$cnt=1;
