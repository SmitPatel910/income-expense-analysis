...
<head>
	...
	<title>Daily Expense Analysis - Sign Up</title>
...
<body>
	<div class="row">
			<h2 align="center">Daily Expense Analysis</h2>
	<hr />
			...
			<div class="login-panel panel panel-default">
				...
				<div class="panel-body">
					<form role="form" action="" method="post" id="" name="signup" onsubmit="return checkpass();">
						<p style="font-size:16px; color:green" align="center"><?php if($msg=="You have successfully registered"){
						echo $msg;
						} ?>
						</p>
						<p style="font-size:16px; color:red" align="center"> <?php if($msg !="You have successfully registered"){
    					echo $msg;
  						}  ?> </p>
						<fieldset>
